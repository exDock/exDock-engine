...
image:https://img.shields.io/badge/exDock-{current-release}-exDock.svg?color=2563eb[link="https://www.ex-dock.com"]
...
To extend the exDock functionality, you need to pull an additional Docker image.
